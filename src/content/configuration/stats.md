...
T> For webpack-dev-server, the properties `quiet` and `noInfo` needs to be in the `devServer` object - both were originally options for webpack 1 and webpack 2, not webpack 3.
